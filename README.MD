# กลับมาทำใหม่ 20/07/2022
Refactor code ใหม่ทั้งหมด ทั้ง front-end(/new-web) และ backend (/api-gateway)

LET'S SEE:https://wongnai-trips-react.vercel.app/

## new code
โค้ดใหม่ ปี 2022 ดูได้ที่ folder /new-web https://github.com/diskette42/fullstack-react-node/tree/main/new-web หรือ https://github.com/diskette42/wongnai-trips-react & https://github.com/diskette42/fullstack-react-node/tree/main/api-gateway


## old code
โค้ดเก่า ปี 2021 ดูได้ที่ folder /web https://github.com/diskette42/fullstack-react-node/tree/main/web & https://github.com/diskette42/fullstack-react-node/tree/old/api-gateway


New Code is in branch 'main',
Old Code is in branch 'old' 
===============================
...
1.Bootstrap => Tailwind & Material ui

2.ปรับให้ compatible ทั้ง pc และ mobile (responsive)

3.จัดเรียง React folder structure ให้ดีขึ้น

4.Refactor code: feature การ fetch api และ setKeyword ให้ดูดีขี้น

5.รับ router จาก router query ex./?keyword=ภูเขา

6.ใช้ useContextAPI จัดการ props (branch beforeUseContextApi => main)

Backend

1.ปรับลดการใช้ built-in function ที่ Code ตัวเก่าที่ค่อนข้างจะยุ่งยากในการอ่าน

2.ปรับ Model Backend เป็นแบบ MVC

## Deployment:

web-app:https://wongnai-trips-react.vercel.app/

Front-end = Vercel (https://github.com/diskette42/wongnai-trips-react) 

Back-end = Heroku (https://trips-node.herokuapp.com/api/trips) || (https://trips-node.herokuapp.com/api/trips?keyword=ภูเขา)
